...
export const LinkedIn = (props) => {
  return (
    ...
    >
      <path
        fill={props.fill}
        d="M100.28 448H7.4V148.9h92.88zm-46.14-350C24.33 98 0 73.7 0 43.6A53.53 53.53 0 0154.14 0c30.46 0 46.14 24.33 46.14 50.38-.02 30.1-15.68 53.62-46.14 53.62zM447.9 448h-92.68V302.4c0-34.73-12.43-58.44-43.51-58.44-23.72 0-37.85 15.93-44.06 31.3-2.27 5.53-2.82 13.22-2.82 20.94V448H172.97s1.25-269.55 0-297.1h92.6v42.07c-.19.31-.45.63-.63.94h.63v-.94c12.31-19.01 34.26-46.13 83.32-46.13 60.89 0 106.62 39.63 106.62 124.77V448z"
      />
    </svg>
  );
};
